...
---@field mode AccountStoreItemMode
...
---@field refundSecondsRemaining? number

---@alias ActionBarSet number
Enum.ActionBarSet = {
	None = 0,
	Mkb = 1,
	Gamepad = 2,
...
---@alias AnimaDiversionNodeState number
...
---@alias AuctionHouseFilterCategory number
...
---@alias AuctionStatus number
Enum.AuctionStatus = {
	Active = 0,
	Sold = 1,
}

---@alias ItemCommodityStatus number
...
---@field drawLayerSublevel number

---@class CustomAuraButtonApplicationBarOptions
---@field maxApplications number
---@field minApplications number
---@field interpolation? StatusBarInterpolation

---@class CustomAuraButtonApplicationCountOptions
---@field formatter? NumericFormatter

---@class CustomAuraButtonCasterNameOptions
---@field showRealmName boolean
---@field useClassColors boolean

---@class CustomAuraButtonDispelTypeTextOptions
---@field showWhenHarmful boolean
---@field showWhenHelpful boolean
...
---@field showWhenHelpful boolean
---@field showWithoutDispelType boolean
---@field stealableFilter? CustomAuraButtonDispelTypeStealableFilter
---@field style CustomAuraButtonDispelTypeTextureStyle
...
---@field interpolation? StatusBarInterpolation
---@field direction? StatusBarTimerDirection

---@class CustomAuraButtonDurationTextOptions
---@field binding? DurationTextBinding
---@field textFormatter? NumericFormatter
---@field textFormat? DurationTextBindingFormatOptions
---@field textColor? DurationTextBindingColorOptions

---@class AutoCompleteResult
---@field name string
---@field priority AutoCompletePriority
---@field bnetID number

---@alias AzeritePowerLevel number
...
---@field friendLevel? BattleNetFriendLevel
---@field lastOnlineTime number
---@field isAFK boolean
---@field isDND boolean
---@field isFavorite boolean
---@field friendTags BattleNetFriendTag[]
...
---@field accountName kstringAuroraName
...
---@field status SimpleOrderStatus
...
---@field timeRemainingSeconds number
---@field name string
---@field price string
...
---@alias ClientSceneType number
Enum.ClientSceneType = {
	DefaultSceneType = 0,
	MinigameSceneType = 1,
}

---@alias ClubActionType number
Enum.ClubActionType = {
...
---@alias ClubInvitationCandidateStatus number
...
---@alias ClubMemberPresence number
...
---@alias ClubRemovedReason number
...
---@alias ClubRestrictionReason number
Enum.ClubRestrictionReason = {
	None = 0,
	Unavailable = 1,
}

---@alias ClubStreamNotificationFilter number
...
---@field memberId ClubMemberOpaqueId
---@field name string
...
---@alias ClubFinderApplicationUpdateType number
...
---@alias ClubFinderClubPostingStatusFlags number
...
---@alias ClubFinderDisableReason number
...
---@alias ClubFinderPostingReportType number
...
---@alias ClubFinderRequestType number
...
---@alias ClubFinderSettingFlags number
...
---@alias PlayerClubRequestStatus number
...
---@alias TrackedSpellsResult number
...
---@alias ConsoleCommandType number
...
---@alias ContributionResult number
...
---@field category CooldownViewerCategory

---@class GroupBuffItem
---@field spellID number
---@field name string
---@field iconID number
---@field flags GroupBuffItemFlags
---@field isKnown boolean
...
---@field sourceDisplayType DamageMeterSourceDisplayType
...
---@alias SelfResurrectOptionType number
...
---@alias CompanionRoleType number
...
---@alias CurioType number
Enum.CurioType = {
	Combat = 0,
	Utility = 1,
}

---@alias TieredEntranceRewardType number
...
---@field id number
---@field quantity number
---@field rewardType TieredEntranceRewardType
...
---@alias Base64Variant number
Enum.Base64Variant = {
	Standard = 0,
	StandardUrlSafe = 1,
}

---@alias CompressionLevel number
...
---@alias CompressionMethod number
...
---@alias ItemSlotFilterType number
...
---@field maxEventDuration? Seconds
...
---@field maxQueueDuration Seconds
...
---@field minimumDuration? Seconds
---@field maximumDuration? Seconds
---@field minimumEventIntroDuration? Seconds
---@field minimumEventGapDuration? Seconds
...
---@alias EndOfMatchType number
Enum.EndOfMatchType = {
	None = 0,
	Plunderstorm = 1,
}

---@alias MatchDetailType number
...
---@alias SubscriptionInterstitialResponseType number
...
---@alias SubscriptionInterstitialType number
...
---@alias TableSecurityOption number
...
---@class ScriptBucketThrottleLimits
---@field luaScriptBucketThrottleMaxMsPerSecondNormal number
---@field luaScriptBucketThrottleMaxMsPerSecondRestricted number
---@field luaScriptBucketThrottleMaxMsBurstNormal number
---@field luaScriptBucketThrottleMaxMsBurstRestricted number

---@class SecureCopyOptions
---@field maxTraversalDepth number
---@field wrapUntrustedFunctions boolean
---@field permitScriptObjects boolean
...
---@field characterCreateOuterBorder number

---@alias GamepadTargetingFilters number
Enum.GamepadTargetingFilters = {
	Hostile = 0,
	Friendly = 1,
	All = 2,
}

---@alias GamepadPossessBarOverride number
Enum.GamepadPossessBarOverride = {
	SpecialPageTopBar = 1,
	Page1LeftBar = 2,
	Page1RightBar = 3,
	Page1BottomBar = 4,
...
---@alias GamepadStanceBarOverride number
Enum.GamepadStanceBarOverride = {
	None = 1,
	Page1LeftBar = 2,
	Page1RightBar = 3,
	Page1BottomBar = 4,
...
---@class GamepadActionBarConstants
...
---@alias GossipOptionRewardType number
Enum.GossipOptionRewardType = {
	Item = 0,
	Currency = 1,
}

---@alias GossipOptionStatus number
...
---@alias GossipOptionUIWidgetSetTypes number
...
---@field refundEligibleEndTime number
---@field nextRenameTime number
---@field renamePrice number
---@field refundAmount number
---@field currentGuildMoney number
---@field result GuildErrorType
---@field oldGuildName string
---@field reservedName string
---@field reservedNameExpirationTime number

---@alias HouseEditorPlayerType number
...
---@alias HousingBasicModeTargetType number
...
---@class HousingCatalogSearchResultsUpdatedCallback
...
---@field recordID number
---@field entryType HousingCatalogEntryType
---@field itemID? number
---@field name string
...
---@field size HousingCatalogEntrySize
...
---@field withStoredEntriesOnly boolean
---@field includeFeaturedCategory boolean
---@field editorModeContext? HouseEditorMode
...
---@alias HousingCleanupModeTargetType number
...
---@alias HousingCustomizeModeTargetType number
...
---@field type HousingRoomComponentType
...
---@field ceilingType HousingRoomComponentCeilingType
---@field doorType HousingRoomComponentDoorType
...
---@alias LightRadiusIndicatorType number
...
---@alias HousingExpertModeTargetType number
...
---@alias HousingExpertSubmodeRestriction number
...
---@alias HousingIncrementType number
...
---@alias HousingPrecisionSubmode number
...
---@class FixturePointUpdatedCallback

---@alias CornerstonePurchaseMode number
...
---@alias CreateNeighborhoodErrorType number
...
---@alias HousingItemToastType number
...
---@field enchantType ItemEnchantType
...
---@field flags UIItemInteractionFlags
---@field description? string
...
---@alias ItemSocketInfoUIType number
...
---@alias CustomBindingType number
Enum.CustomBindingType = {
	VoicePushToTalk = 0,
}

---@alias TurnStrafeStyle number
...
---@field generalPlaystyle? LFGEntryGeneralPlaystyle
...
---@alias PlunderstormQueueState number
...
---@alias EncounterLootDropRollState number
...
---@field hideRenownLevelUpToast boolean
...
---@class MajorFactionProgressionInfo
---@field renownLevel number
---@field previousWeekProgressiveMaxLevel number
---@field currentWeekProgressiveMaxLevel number
---@field maxLevel number
---@field renownReputationEarned number
---@field renownLevelThreshold number
---@field weekNumber number
...
---@field taskType NeighborhoodInitiativeTaskType
---@field sortOrder number
---@field rewardQuestID number
...
---@alias LeavePartyConfirmReason number
...
---@field eventStartTime? number
---@field eventEndTime? number
---@field requirementsList CriteriaRequirement[]
---@field criteriaList CriteriaRequiredValue[]
...
---@field spellID number
---@field itemID number
---@field textureFileDataID number
...
---@class PendingPingOffScreenCallback

---@class PingCooldownStartedCallback

---@class PingPinFrameAddedCallback

---@class PingPinFrameRemovedCallback

---@class PingPinFrameScreenClampStateUpdatedCallback

---@class PingRadialWheelCreatedCallback

---@class SendMacroPingCallback

---@class TogglePingListenerCallback

---@alias ClientPlatformType number
Enum.ClientPlatformType = {
	Windows = 0,
	Macintosh = 1,
}

---@alias PlayerChoiceRarity number
...
---@field playerChoiceLayout PlayerChoiceLayout
...
---@field name string
---@field matchmakingType PvPMatchmakingType
---@field minPlayers number
---@field maxPlayers number
---@field icon number
---@field longDescription string
...
---@field minItemLevel number
---@field shouldHideRewardIcon boolean
...
---@alias QuestLineFloorLocation number
...
---@alias MapOverlayDisplayLocation number
...
---@alias QuestWatchType number
Enum.QuestWatchType = {
	Automatic = 0,
	Manual = 1,
}

---@alias WorldQuestQuality number
...
---@field questClassification QuestClassification
...
---@class QuestTimerInfo
---@field questID number
---@field questTimer number
...
---@field isAFK boolean
---@field isOffline boolean
---@field interactionCategoryFilters RecentAlliesInteractionCategoryFilter[]
...
---@alias RafRecruitSubStatus number
...
---@alias ReputationSortType number
...
---@alias ScriptedAnimationBehavior number
...
---@alias ScriptedAnimationFlags number
Enum.ScriptedAnimationFlags = {
	UseTargetAsSource = 1,
}

---@alias ScriptedAnimationTrajectory number
...
---@class GroupCurrencyInfo
---@field traitNodeGroupID number
---@field currencyInfos TreeCurrencyInfo[]
...
---@field isCollapsed boolean
---@field rank number
---@field tempPoints number
---@field modifier number
---@field maxRank number
---@field isAbandonable boolean
---@field stepCost number
---@field rankCost number
---@field minLevel number
...
---@alias SocialUIBlockType number
...
---@alias SocialUIPresenceType number
...
---@field soundKitID number
---@field uiSoundSubType UISoundSubType
...
---@alias SpecializationSystem number
...
---@field category SpellDiminishCategory
---@field name string
---@field icon? number
...
---@field creatureID number
---@field specID number
---@field loyaltyLevel number
---@field loyaltyName string
---@field happinessLevel number
---@field experience number
---@field experienceNeeded number
...
---@alias FlightPathFaction number
...
---@class GetTitleIconTextureCallback

---@alias TooltipComparisonMethod number
...
---@class TransmogOutfitCollectionInfo
---@field name string
...
---@class TransmogOutfitOptionInfo
---@field type TransmogOutfitSlotOption
---@field name string
---@field enabled boolean

---@class TransmogOutfitOptionSheatheCategoryInfo
---@field sheatheCategory TransmogOutfitSlotOptionSheatheCategory
---@field categoryName string

---@class TransmogOutfitSlotGroup
---@field position TransmogOutfitSlotPosition
---@field appearanceSlotInfo TransmogOutfitSlotInfo[]
---@field illusionSlotInfo TransmogOutfitSlotInfo[]

---@class TransmogOutfitSlotInfo
---@field slot TransmogOutfitSlot
---@field type TransmogType
---@field collectionType TransmogCollectionType
...
---@field transmogID number
---@field displayType TransmogOutfitDisplayType
---@field isTransmogrified boolean
---@field hasPending boolean
---@field isPendingCollected boolean
---@field canTransmogrify boolean
---@field warning TransmogOutfitSlotWarning
---@field warningText string
---@field error TransmogOutfitSlotError
---@field errorText string
---@field texture? number
---@field sheatheCategory TransmogOutfitSlotOptionSheatheCategory

---@alias TransmogPendingType number
...
---@alias TransmogCameraVariation number
...
---@field minIlvl number
---@field isValidForEquippedItem boolean
...
---@alias FrameTutorialAccount number
...
---@alias UIFrameType number
Enum.UIFrameType = {
	JailersTowerBuffs = 0,
	InterruptTutorial = 1,
}

---@class MacroExecuteLineCallback
...
---@alias CaptureBarWidgetFillDirectionType number
Enum.CaptureBarWidgetFillDirectionType = {
	RightToLeft = 0,
	LeftToRight = 1,
}

---@alias IconAndTextShiftTextType number
Enum.IconAndTextShiftTextType = {
	None = 0,
	ShiftText = 1,
}

---@alias IconAndTextWidgetState number
...
---@alias ItemDisplayTextDisplayStyle number
...
---@alias ItemDisplayTooltipEnabledType number
Enum.ItemDisplayTooltipEnabledType = {
	Enabled = 0,
	Disabled = 1,
}

---@alias MapPinAnimationType number
Enum.MapPinAnimationType = {
	None = 0,
	Pulse = 1,
}

---@alias PreyHuntProgressState number
...
---@alias SpellDisplayIconDisplayType number
...
---@alias SpellDisplayTextShownStateType number
Enum.SpellDisplayTextShownStateType = {
	Shown = 0,
	Hidden = 1,
}

---@alias SpellDisplayTint number
Enum.SpellDisplayTint = {
	None = 0,
	Red = 1,
}

---@alias StatusBarColorTintValue number
...
---@alias StatusBarOverrideBarTextShownType number
...
---@alias StatusBarValueTextType number
...
---@alias TugOfWarMarkerArrowShownState number
...
---@alias TugOfWarStyleValue number
Enum.TugOfWarStyleValue = {
	DefaultYellow = 0,
	ArchaeologyBrown = 1,
}

---@alias UIWidgetBlendModeType number
Enum.UIWidgetBlendModeType = {
	Opaque = 0,
	Additive = 1,
}

---@alias UIWidgetButtonEnabledState number
Enum.UIWidgetButtonEnabledState = {
	Disabled = 0,
	Enabled = 1,
}

---@alias UIWidgetButtonIconType number
...
---@alias UIWidgetMotionType number
Enum.UIWidgetMotionType = {
	Instant = 0,
	Smooth = 1,
}

---@alias UIWidgetOverrideState number
Enum.UIWidgetOverrideState = {
	Inactive = 0,
	Active = 1,
}

---@alias UIWidgetRewardShownState number
...
---@alias UIWidgetSpellButtonCooldownType number
...
---@alias UIWidgetTextFormatType number
...
---@alias UIWidgetTextSizeType number
...
---@alias UIWidgetTextureAndTextSizeType number
...
---@alias UIWidgetTooltipLocation number
...
---@alias UIWidgetUpdateAnimType number
...
---@alias WidgetAnimationType number
Enum.WidgetAnimationType = {
	None = 0,
	Fade = 1,
}

---@alias WidgetCurrencyClass number
Enum.WidgetCurrencyClass = {
	Currency = 0,
	Item = 1,
}

---@alias WidgetEnabledState number
...
---@alias WidgetGlowAnimType number
Enum.WidgetGlowAnimType = {
	None = 0,
	Pulse = 1,
}

---@alias WidgetIconSizeType number
...
---@alias WidgetIconSourceType number
Enum.WidgetIconSourceType = {
	Spell = 0,
	Item = 1,
}

---@alias WidgetOpacityType number
...
---@alias WidgetShowGlowState number
Enum.WidgetShowGlowState = {
	HideGlow = 0,
	ShowGlow = 1,
}

---@alias WidgetShownState number
Enum.WidgetShownState = {
	Hidden = 0,
	Shown = 1,
}

---@alias WidgetTextHorizontalAlignmentType number
...
---@alias WidgetUnitPowerBarFlashMomentType number
...
---@alias ZoneControlActiveState number
Enum.ZoneControlActiveState = {
	Inactive = 0,
	Active = 1,
}

---@alias ZoneControlDangerFlashType number
...
---@alias ZoneControlFillType number
...
---@alias ZoneControlLeadingEdgeType number
Enum.ZoneControlLeadingEdgeType = {
	NoLeadingEdge = 0,
	UseLeadingEdge = 1,
}

---@alias ZoneControlMode number
...
---@field shownState WidgetShownState
---@field animType MapPinAnimationType
---@field widgetSizeSetting number
---@field textureKit textureKit
---@field frameTextureKit textureKit
---@field hasTimer boolean
...
---@field shownState WidgetShownState
---@field progressState PreyHuntProgressState
---@field tooltip string
---@field tooltipLoc UIWidgetTooltipLocation
---@field widgetSizeSetting number
---@field textureKit textureKit
...
---@field groupAlignment UIWidgetHorizontalDirection
...
---@field itemNameCustomColor WidgetEnabledState
---@field itemNameCustomColorOverrideState UIWidgetOverrideState

---@class UIWidgetRewardInfo
---@field shownState UIWidgetRewardShownState
...
---@field spellID number
---@field tooltip string
---@field icon UIWidgetButtonIconType
---@field enabledState UIWidgetButtonEnabledState
---@field cooldownType UIWidgetSpellButtonCooldownType
...
---@alias PvPUnitClassification number
...
---@alias GraphicsValidationResult number
...
---@field objectiveType? VignetteObjectiveType

---@alias CommunicationMode number
Enum.CommunicationMode = {
	PushToTalk = 0,
	OpenMic = 1,
}

---@alias VoiceChannelErrorReason number
Enum.VoiceChannelErrorReason = {
	Unknown = 0,
	IsBattleNetChannel = 1,
}

---@alias VoiceChatStatusCode number
...
---@alias ConquestProgressBarDisplayType number
...
---@alias WoWEntitlementType number
...
C_AccessibilityOptions = C_AccessibilityOptions or {}
C_AccountInfo = C_AccountInfo or {}
C_AccountStore = C_AccountStore or {}
C_AchievementInfo = C_AchievementInfo or {}
C_AchievementTelemetry = C_AchievementTelemetry or {}
C_ActionBar = C_ActionBar or {}
C_AddOnProfiler = C_AddOnProfiler or {}
C_AddOns = C_AddOns or {}
C_AdventureJournal = C_AdventureJournal or {}
C_AdventureMap = C_AdventureMap or {}
C_AlliedRaces = C_AlliedRaces or {}
C_AnimaDiversion = C_AnimaDiversion or {}
C_ArdenwealdGardening = C_ArdenwealdGardening or {}
C_AreaPoiInfo = C_AreaPoiInfo or {}
C_ArtifactUI = C_ArtifactUI or {}
C_AssistedCombat = C_AssistedCombat or {}
C_AuctionHouse = C_AuctionHouse or {}
C_AuraContainerUtil = C_AuraContainerUtil or {}
C_AutoComplete = C_AutoComplete or {}
C_AutoLoot = C_AutoLoot or {}
C_AzeriteEmpoweredItem = C_AzeriteEmpoweredItem or {}
C_AzeriteEssence = C_AzeriteEssence or {}
C_AzeriteItem = C_AzeriteItem or {}
C_Bank = C_Bank or {}
C_BarberShop = C_BarberShop or {}
C_BarberShopInternal = C_BarberShopInternal or {}
C_BattleNet = C_BattleNet or {}
C_BattlePet = C_BattlePet or {}
C_BehavioralMessaging = C_BehavioralMessaging or {}
C_BlackMarketInfo = C_BlackMarketInfo or {}
C_BlizzCon2026 = C_BlizzCon2026 or {}
C_Browser = C_Browser or {}
C_Calendar = C_Calendar or {}
C_CampaignInfo = C_CampaignInfo or {}
C_CatalogShop = C_CatalogShop or {}
C_ChallengeMode = C_ChallengeMode or {}
C_ChatBubbles = C_ChatBubbles or {}
C_ChatInfo = C_ChatInfo or {}
C_ChromieTime = C_ChromieTime or {}
C_CinematicList = C_CinematicList or {}
C_ClassColor = C_ClassColor or {}
C_ClassTalents = C_ClassTalents or {}
C_ClassTrial = C_ClassTrial or {}
C_ClickBindings = C_ClickBindings or {}
C_ClientScene = C_ClientScene or {}
C_Club = C_Club or {}
C_ClubFinder = C_ClubFinder or {}
...
C_CombatLogInternal = C_CombatLogInternal or {}
C_CombatLogSecure = C_CombatLogSecure or {}
C_CombatText = C_CombatText or {}
C_Commentator = C_Commentator or {}
C_CompactUnitFrames = C_CompactUnitFrames or {}
C_ConfigurationWarnings = C_ConfigurationWarnings or {}
C_ConsoleScriptCollection = C_ConsoleScriptCollection or {}
C_Container = C_Container or {}
C_ContentTracking = C_ContentTracking or {}
C_ContributionCollector = C_ContributionCollector or {}
C_CooldownViewer = C_CooldownViewer or {}
C_CovenantCallings = C_CovenantCallings or {}
C_CovenantPreview = C_CovenantPreview or {}
C_Covenants = C_Covenants or {}
C_CovenantSanctumUI = C_CovenantSanctumUI or {}
C_CraftingOrders = C_CraftingOrders or {}
C_CreatureInfo = C_CreatureInfo or {}
C_CurrencyInfo = C_CurrencyInfo or {}
C_Cursor = C_Cursor or {}
C_CursorUtil = C_CursorUtil or {}
C_CurveUtil = C_CurveUtil or {}
C_CVar = C_CVar or {}
C_DamageMeter = C_DamageMeter or {}
C_DateAndTime = C_DateAndTime or {}
C_DeathAlert = C_DeathAlert or {}
C_DeathInfo = C_DeathInfo or {}
C_DeathRecap = C_DeathRecap or {}
C_DelvesUI = C_DelvesUI or {}
C_Discord = C_Discord or {}
C_DuelInfo = C_DuelInfo or {}
C_DurationUtil = C_DurationUtil or {}
C_DyeColor = C_DyeColor or {}
C_EditMode = C_EditMode or {}
C_EncodingUtil = C_EncodingUtil or {}
C_EncounterEvents = C_EncounterEvents or {}
C_EncounterInfo = C_EncounterInfo or {}
C_EncounterJournal = C_EncounterJournal or {}
C_EncounterTimeline = C_EncounterTimeline or {}
C_EncounterWarnings = C_EncounterWarnings or {}
C_EndOfMatchUI = C_EndOfMatchUI or {}
C_EquipmentSet = C_EquipmentSet or {}
C_EventScheduler = C_EventScheduler or {}
C_EventToastManager = C_EventToastManager or {}
...
C_GamepadTargeting = C_GamepadTargeting or {}
C_GamepadUI = C_GamepadUI or {}
C_GameRules = C_GameRules or {}
C_Garrison = C_Garrison or {}
C_GenericWidgetDisplay = C_GenericWidgetDisplay or {}
C_Glue = C_Glue or {}
C_GlyphInfo = C_GlyphInfo or {}
C_GMTicketInfo = C_GMTicketInfo or {}
C_GossipInfo = C_GossipInfo or {}
C_GuildBank = C_GuildBank or {}
C_GuildInfo = C_GuildInfo or {}
C_HeirloomInfo = C_HeirloomInfo or {}
C_HouseEditor = C_HouseEditor or {}
C_HouseExterior = C_HouseExterior or {}
C_Housing = C_Housing or {}
C_HousingBasicMode = C_HousingBasicMode or {}
C_HousingBlueprint = C_HousingBlueprint or {}
C_HousingCatalog = C_HousingCatalog or {}
C_HousingCleanupMode = C_HousingCleanupMode or {}
C_HousingCustomizeMode = C_HousingCustomizeMode or {}
C_HousingDecor = C_HousingDecor or {}
C_HousingExpertMode = C_HousingExpertMode or {}
C_HousingInspectMode = C_HousingInspectMode or {}
C_HousingLayout = C_HousingLayout or {}
C_HousingNeighborhood = C_HousingNeighborhood or {}
C_ImmersiveInteraction = C_ImmersiveInteraction or {}
C_IncomingSummon = C_IncomingSummon or {}
C_InputInterfaceStyle = C_InputInterfaceStyle or {}
C_InstanceEncounter = C_InstanceEncounter or {}
C_InstanceLeaver = C_InstanceLeaver or {}
C_InterfaceFileManifest = C_InterfaceFileManifest or {}
C_Intl = C_Intl or {}
C_InvasionInfo = C_InvasionInfo or {}
C_IslandsInfo = C_IslandsInfo or {}
C_IslandsQueue = C_IslandsQueue or {}
C_Item = C_Item or {}
C_ItemInteraction = C_ItemInteraction or {}
C_ItemSocketInfo = C_ItemSocketInfo or {}
C_ItemText = C_ItemText or {}
C_ItemUpgrade = C_ItemUpgrade or {}
C_KeyBindings = C_KeyBindings or {}
C_LegendaryCrafting = C_LegendaryCrafting or {}
C_LevelLink = C_LevelLink or {}
C_LevelSquish = C_LevelSquish or {}
C_LFGInfo = C_LFGInfo or {}
C_LFGList = C_LFGList or {}
C_LFGListRoles = C_LFGListRoles or {}
C_LimitedInput = C_LimitedInput or {}
...
C_LootHistory = C_LootHistory or {}
C_LootJournal = C_LootJournal or {}
C_LoreText = C_LoreText or {}
C_LossOfControl = C_LossOfControl or {}
C_MacOptions = C_MacOptions or {}
C_Macro = C_Macro or {}
C_Mail = C_Mail or {}
C_MajorFactions = C_MajorFactions or {}
C_Map = C_Map or {}
C_MapExplorationInfo = C_MapExplorationInfo or {}
C_MerchantFrame = C_MerchantFrame or {}
C_Minimap = C_Minimap or {}
C_ModelInfo = C_ModelInfo or {}
C_ModifiedInstance = C_ModifiedInstance or {}
...
C_SpellDiminish = C_SpellDiminish or {}
C_SplashScreen = C_SplashScreen or {}
C_StableInfo = C_StableInfo or {}
C_StorePublic = C_StorePublic or {}
C_StringUtil = C_StringUtil or {}
C_SummonInfo = C_SummonInfo or {}
C_SuperTrack = C_SuperTrack or {}
C_SwingTimer = C_SwingTimer or {}
C_System = C_System or {}
C_SystemVisibilityManager = C_SystemVisibilityManager or {}
C_TalkingHead = C_TalkingHead or {}
C_TaskQuest = C_TaskQuest or {}
C_TaxiMap = C_TaxiMap or {}
C_Texture = C_Texture or {}
C_Timer = C_Timer or {}
C_TimerunningUI = C_TimerunningUI or {}
C_TooltipComparison = C_TooltipComparison or {}
C_TooltipInfo = C_TooltipInfo or {}
C_ToyBoxInfo = C_ToyBoxInfo or {}
C_TradeInfo = C_TradeInfo or {}
C_TradeSkillUI = C_TradeSkillUI or {}
C_Trainer = C_Trainer or {}
C_TraitConfig = C_TraitConfig or {}
...
C_TTSSettings = C_TTSSettings or {}
C_Tutorial = C_Tutorial or {}
C_UI = C_UI or {}
C_UIActionHandler = C_UIActionHandler or {}
C_UIColor = C_UIColor or {}
C_UIFileAsset = C_UIFileAsset or {}
C_UIWidgetManager = C_UIWidgetManager or {}
C_UnitAuras = C_UnitAuras or {}
C_UserFeedback = C_UserFeedback or {}
C_Vehicle = C_Vehicle or {}
C_VideoOptions = C_VideoOptions or {}
C_VignetteInfo = C_VignetteInfo or {}
C_VoiceChat = C_VoiceChat or {}
C_WarbandScene = C_WarbandScene or {}
C_Weather = C_Weather or {}
C_WeeklyRewards = C_WeeklyRewards or {}
C_WorldLootObject = C_WorldLootObject or {}
C_WorldSafeLocsUIInternal = C_WorldSafeLocsUIInternal or {}
C_WorldStateInfo = C_WorldStateInfo or {}
C_WowEntitlementInfo = C_WowEntitlementInfo or {}
C_WowSurvey = C_WowSurvey or {}
C_WowTokenUI = C_WowTokenUI or {}
...
---@param setToSearch ActionBarSet
---@return number[] slots
...
---@param arguments LuaValueVariant
...
---@param name uiAddon
---@return AddOnSecurityStatus security
...
---@param  CustomAuraButtonApplicationCountOptions
...
---@param  CustomAuraButtonCasterNameOptions
...
---@param  CustomAuraButtonDispelTypeTextOptions
...
---@param  CustomAuraButtonDispelTypeTextureOptions
...
---@param  CustomAuraButtonDurationBarOptions
...
---@param  CustomAuraButtonDurationTextOptions
...
---@return BankType[] viewableBankTypes
...
---@param featureMask ChrModelFeatureFlags
...
---@param friendTag BattleNetFriendTag
...
---@param id number
---@param friendTags BattleNetFriendTag[]
...
---@return Bc26Experience experience
...
---@param experience Bc26Experience
...
---@param clubId ClubId
---@param memberId ClubMemberOpaqueId
...
---@param clubId ClubId
---@param  ClubStreamId
---@return ClubMemberOpaqueId[] members
...
---@param category CombatAudioAlertCategory
---@return number voice
...
---@param unit CombatAudioAlertUnit
---@param alertType CombatAudioAlertType
...
---@param setting CombatAudioAlertSpecSetting
---@return number value
function C_CombatAudioAlert.GetSpecSetting(setting) end

---@param throttleType CombatAudioAlertThrottle
...
---@param mask CombatLogObject
---@param flags CombatLogObject
...
---@param colorG number
---@param colorB number
---@param order CombatLogMessageOrder
...
---@return ConnectionProtocol protocolTypes
...
---@return ContentTrackingResult result
---@return  mapID
...
---@param id number
---@return ContentTrackingTargetType targetType
...
---@param cooldownID number
---@return CooldownViewerAlertEventType[] validAlertTypes
...
---@param currencyID number
---@return  warModeApplies
---@return  limitOncePerTooltip
...
---@param sessionType DamageMeterSessionType
---@param type DamageMeterType
---@return DamageMeterCombatSession session
...
---@return TieredEntranceType entranceType
...
---@return WorldTierDifficulty difficulty
...
---@return KStringDiscordUserName userName
function C_Discord.GetDiscordUserName(userID) end

---@return DiscordDisplayNameType type
...
---@param setting DiscordGuildSettings
---@return boolean isSet
...
function ClearTextColorCurve() end
...
---@return colorRGBA color
function GetFormattedTextColor() end

--- Returns the text color curve used by this binding.
---@return LuaColorCurveObject curve
---@return DurationTextBindingProperty property
function GetTextColorCurve() end

--- Returns the time modifier used when sampling duration values for this binding.
---@return DurationTimeModifier modifier
...
---@param property DurationTextBindingProperty
function SetTextColorCurve(curve, property) end
...
function SetTextFormat(formatString, components) end
...
---@param  LuaValueVariant
---@param  CBORSerializationOptions
---@return string output
function C_EncodingUtil.SerializeCBOR(value, options) end

---@param  LuaValueVariant
---@param  JSONSerializationOptions
---@return string output
...
---@param trigger EncounterEventColorTrigger
---@return  color
...
---@return Seconds loopTimerDuration
...
---@param eventID EncounterTimelineEventID
---@param  EncounterEventColorTrigger
---@return colorRGBA color
...
---@param track EncounterTimelineTrack
---@return Seconds maxEventDuration
...
---@param severity EncounterEventSeverity
---@return colorRGBA color
...
---@return  expansionTrialRemainingSeconds
...
---@param inventorySlots number
---@param category TransmogOutfitSlotOptionSheatheCategory
...
---@param unit UnitToken
---@return boolean success
function SetModelByUnitCreatureDisplayID(unit) end
...
function AddFontStrings(leftFontString, rightFontString) end
...
---@param values LuaValueReference
...
---@param method string
---@param arguments LuaValueReference
...
---@param option TableSecurityOption
...
---@param filter GamepadTargetingFilters
function C_GamepadTargeting.SetFilter(filter) end

---@return  activeStanceFirstGamepadStorageSlotIndex
...
---@return  garrTalentTreeCurrencyType
...
---@return  gossipOptionUIWidgetSetsAndTypes
...
---@param editMode HouseEditorMode
---@return HousingResult result
...
---@return HouseEditorMode editMode
...
---@return HouseEditorPlayerType playerType
...
---@param coreFixtureType HousingFixtureType
---@return  coreFixtureOptionsInfo
function C_HouseExterior.GetCoreFixtureOptionsInfo(coreFixtureType) end

---@return  houseExteriorSize
function C_HouseExterior.GetCurrentHouseExteriorSize() end

---@return  houseExteriorTypeID
---@return  houseExteriorTypeName
...
---@param attachedDecorAction HousingFixtureDecorAction
...
---@param type HousingBlueprintType
...
---@return HousingBlueprintType type
...
---@return HousingResult availability
...
---@return HousingResult blueprintsAvailability
...
---@return HousingCatalogSortType sortType
...
---@param sortType HousingCatalogSortType
...
---@param entryType HousingCatalogEntryType
...
---@param  string
---@param petBehavior HousingPetBehaviorType
...
---@return  petID
---@return HousingPetBehaviorType petBehavior
...
---@param type HousingRoomComponentType
...
---@param roomGUID string
---@param componentID number
---@param newDoortype HousingRoomComponentDoorType
...
---@param roomGUID string
---@param componentID number
---@param ceilingType HousingRoomComponentCeilingType
...
---@return  interiorMaxBudgets
---@return  exteriorMaxBudgets
...
---@return  interiorSpentBudgets
---@return  exteriorSpentBudgets
...
---@param subMode HousingPrecisionSubmode
---@return HousingExpertSubmodeRestriction restriction
...
---@param incrementType HousingIncrementType
---@param active boolean
...
---@return HousingLayoutRestriction moveRestriction
function CanMove() end

---@return HousingLayoutRestriction removalRestriction
function CanRemove() end

---@return HousingLayoutRestriction rotateRestriction
...
---@return HousingLayoutPinType type
...
---@param  HousingLayoutStairDirection
...
---@param direction HousingLayoutCameraDirection
...
--- Only available when interacting with a cornerstone game object
---@return CornerstonePurchaseMode purchaseMode
...
--- Only available when interacting with a cornerstone game object
---@return PurchaseHouseDisabledReason cantPurchaseReason
...
---@param plotIndex number
---@return InvalidPlotScreenshotReason reason
...
---@return HouseSettingFlags accessFlags
...
---@return InputDeviceInterfaceType style
...
---@param currencyCode string
---@param nameStyle CurrencyNameStyle
---@return string result
...
---@return TransmogOutfitSlotError errorCode
...
---@return ItemSocketInfoUIType uiType
...
---@param newContext BindingContext
...
---@param activityID number
---@param groupID number
---@param  LFGEntryPlaystyle
---@param  LFGEntryGeneralPlaystyle
---@return boolean matches
...
---@param generalPlaystyle LFGEntryGeneralPlaystyle
...
---@param modifier DurationTimeModifier
---@return Seconds elapsedDuration
...
---@param modifier DurationTimeModifier
---@return Seconds remainingDuration
...
---@return  osShortcutsDisabledCVar
...
---@param scale number
function SetIconScale(scale) end
...
function SetUsingSoftCursor(usingSoftCursor) end
...
---@param pointX number
---@param pointY number
function UpdateMouseoverAtPoint(pointX, pointY) end
...
---@param spellID number
---@return  mountCreatureDisplayInfoLink
...
---@return  masterLootPartyID
---@return  masterLooterRaidID
function C_PartyInfo.GetLootMethod() end

---@return LootMethodStyles methodStyle
function C_PartyInfo.GetLootMethodStyle() end

---@param avgItemLevelCategory AvgItemLevelCategories
...
---@return RestrictPingsTo restrictTo
...
---@param restrictTo RestrictPingsTo
...
---@return PhotoSharingStatus status
...
---@param mousePosY number
---@param  boolean
---@return PingSetTargetState state
...
---@return PvPRanks lifetimeMaxPVPRank
...
---@param honorLevel number
---@return  nextHonorLevelWithReward
...
---@return  portraitGiverModelSceneID
...
---@return QuestTimerInfo[] questTimers
...
---@param questID number
---@param type MapIconUIWidgetSetType
...
---@param interactionCategoryFilter RecentAlliesInteractionCategoryFilter
...
---@return RecruitAFriendFailure reason
...
---@param  RecruitAFriendRewardsVersion
---@return boolean success
...
---@param type AddOnRestrictionType
---@return AddOnRestrictionState state
...
---@param seconds Seconds
---@return SecondsFormatterInterval interval
...
---@param seconds Seconds
---@param  SecondsFormatterAbbreviation
...
---@return Seconds approximationSeconds
...
---@return SecondsFormatterRounding rounding
function GetRounding() end

--- Returns the whitespace stripping mode of the formatter.
---@return SecondsFormatterIntervalWhitespace strip
...
---@param abbreviation SecondsFormatterAbbreviation
...
---@param interval SecondsFormatterInterval
...
---@param rounding SecondsFormatterRounding
function SetRounding(rounding) end

--- Sets the whitespace stripping mode for the formatter.
---@param strip SecondsFormatterIntervalWhitespace
...
---@return GroupCurrencyInfo[] groupCurrencyInfos
function C_Traits.GetGroupCurrencyInfo(configID, groupIDs) end

---@param treeID number
---@return TraitGroupDisplayInfo[] displayInfos
...
---@param bindingType ScriptBindingType
---@return LuaFunctionReference script
...
---@param scriptTypeName ScriptTypeName
---@param script LuaFunctionReference
---@param bindingType ScriptBindingType
---@return boolean success
...
function GetFromPercent() end

---@return number percent
function GetToPercent() end

---@param percent number
function SetFromPercent(percent) end

---@param percent number
function SetToPercent(percent) end
...
---@return FontStringScaleAnimationMode scaleAnimationMode
...
---@param scaleAnimationMode FontStringScaleAnimationMode
...
function AddRoleset(roleset) end
...
function CreateVectorGraphics(name, drawLayer, templateName, subLevel) end
...
---@return OnUpdateMode onUpdateMode
function GetOnUpdateMode() end
...
function IsRolesetFiltered() end
...
---@param buttons MouseButton
function RegisterForDrag(buttons) end

---@param eventName string
---@param units UnitTokenType
---@return boolean registered
...
---@param roleset string
function RemoveRoleset(roleset) end

function ResizeToBoundsRect() end
...
---@param value boolean
---@param alphaIfTrue SingleColorValue
---@param alphaIfFalse SingleColorValue
...
---@param onUpdateMode OnUpdateMode
function SetOnUpdateMode(onUpdateMode) end
...
---@param  string
function SetRolesets(rolesetsString) end
...
---@param restrictions ScriptObjectAccessRestriction
function AddAccessRestrictions(restrictions) end

--- Adds forbidden aspects to a script object, restricting access to various functionalities such as script bindings.
---@param aspects ForbiddenAspect
function AddForbiddenAspects(aspects) end

---@param aspect SecretAspect
function AddSecretAspect(aspect) end

--- Returns whether the current Lua execution context has permission to access this object.
---@return boolean canAccess
function CanBeAccessedInContext() end

--- Returns the mask of all access restrictions applied to this object.
---@return ScriptObjectAccessRestriction restrictions
function GetAccessRestrictions() end

--- Returns the mask of all forbidden aspects applied to this object.
---@return ForbiddenAspect aspects
function GetForbiddenAspects() end

--- Returns the mask of all forbidden aspects applied to this object that can propagate to others.
---@param path ScriptObjectPropagationPath
---@return ForbiddenAspect aspects
function GetInheritableForbiddenAspects(path) end

---@return string name
function GetName() end

---@return FrameScriptObject objectTable
function GetObjectTable() end
...
function FocusEnter(fromMouseMotion) end

---@param fromMouseMotion boolean
function FocusExit(fromMouseMotion) end
...
---@return boolean enabled
function GetRoundLayoutToNearestPixel() end
...
---@param enabled boolean
function SetRoundLayoutToNearestPixel(enabled) end
...
---@return StatusBarRenderMode renderMode
...
---@param minValue number
---@param maxValue number
---@param interpolation StatusBarInterpolation
function SetMinMaxValues(minValue, maxValue, interpolation) end

---@param orientation Orientation
function SetOrientation(orientation) end

---@param renderMode StatusBarRenderMode
...
---@param duration LuaDurationObject
---@param interpolation StatusBarInterpolation
---@param direction StatusBarTimerDirection
...
function ClearRadialProgressBar() end

function ClearSVG() end
...
function SetRadialProgressBarEndOffset(offset) end
...
---@param uiSoundSubType UISoundSubType
...
---@param vocalErrorSoundID Vocalerrorsounds
...
---@return  masterySpell1
---@return  masterySpell2
...
---@return SpecializationSystem system
...
---@param weaponSlot WeaponSlot
---@param enchantmentType ItemEnchantType
...
---@param spellID number
---@param visibilityType SpellAuraVisibilityType
...
---@return SpellBookSpellBank spellBookItemSpellBank
...
---@param spellBookItemSlotIndex number
---@param spellBookItemSpellBank SpellBookSpellBank
---@return SpellBookItemType itemType
...
---@param spellID number
---@param spellBank SpellBookSpellBank
...
---@param category SpellDiminishCategory
---@param ruleset SpellDiminishRuleset
---@return boolean isTracked
...
---@return ContentTrackingType trackableType
...
---@return SuperTrackingMapPinType type
...
---@param swingType PlayerSwingType
---@param enable boolean
...
---@param itemGUID string
---@param  CraftingReagentInfo[]
---@param  CraftingItemSlotModification[]
---@param  boolean
---@return boolean result
...
---@param slot TransmogOutfitSlot
---@return boolean valid
function C_TransmogOutfitInfo.CanPlayerTransmogSlot(slot) end

---@param outfitID number
---@param trigger TransmogSituationTrigger
...
---@param slot TransmogOutfitSlot
---@param option TransmogOutfitSlotOption
---@param collectionType TransmogCollectionType
---@return TransmogOutfitCollectionInfo collectionInfo
...
---@param slot TransmogOutfitSlot
---@return TransmogOutfitSlotOption option
...
---@param source TransmogOutfitEntrySource
...
---@param slot TransmogOutfitSlot
---@return TransmogOutfitOptionInfo[] options
...
---@return TransmogOutfitSlot slot
...
---@param displayType TransmogOutfitDisplayType
...
---@param appearanceID number
---@param  TransmogCollectionType
---@param  TransmogLocation
---@return AppearanceSourceInfo[] sources
...
---@param  TransmogLocation
---@param  TransmogOutfitSlotOption
...
---@return  detailsCameraID
---@return  vendorCameraID
...
---@param unit UnitTokenPvPRestrictedForAddOns
---@param  UnitTokenPvPRestrictedForAddOns
...
---@param  number
---@param sortRule UnitAuraSortRule
---@param sortDirection UnitAuraSortDirection
...
---@return UnitDamageAbsorbClampMode damageAbsorbClampMode
...
---@return UnitHealAbsorbClampMode healAbsorbClampMode
function GetHealAbsorbClampMode() end

--- Returns the configured heal absorb processing mode.
---@return UnitHealAbsorbMode healAbsorbMode
...
---@return UnitIncomingHealClampMode incomingHealClampMode
...
---@return UnitMaximumHealthMode maximumHealthMode
...
---@param damageAbsorbClampMode UnitDamageAbsorbClampMode
...
---@param healAbsorbClampMode UnitHealAbsorbClampMode
...
---@param maximumHealthMode UnitMaximumHealthMode
...
---@return  bestUniqueVignetteIndex
...
---@param  WeeklyRewardChestThresholdType
...
---@param deliveryMoment SurveyDeliveryMoment
